<?php
	...
	function showusers() {
		...
		global $conn;  
		$sql = "SELECT counsellors.firstname Cname,counsellors.secondname ClastName,ROUND(AVG(review.rating),1) rating,counsellor_exper.counsellor_exp expe FROM `counsellors`";
    ...
    <div class="container mb-5">
        <div class="row">
            <ol class="col-12 breadcrumb">
                ...
                <li class="breadcrumb-item active">Consellors List</li>
            </ol>
            <div class="col-12">
               <h3>Users</h3>
               <hr>
